    ...
    <Box className="bg-gradient-to-br from-gray-200 via-blue-100 to-blue-200 min-h-screen pt-24 p-5">
      ...
      <section className="mb-12">
        ...
        <ul className="pl-5 text-gray-700">
          <li className="mb-2 ml">→ We believe in the triune God...</li>
          <li className="mb-2 ml">→ We uphold the Bible as inspired...</li>
          <li className="mb-2 ml">→ Salvation is through faith...</li>
          <li className="mb-2 ml">→ The Church is called to evangelize...</li>
          <li className="mb-2 ml">→ We value prayer, worship...</li>
        </ul>
      </section>
