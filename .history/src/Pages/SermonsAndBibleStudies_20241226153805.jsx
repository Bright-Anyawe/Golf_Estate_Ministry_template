...
const Sermons = () => {
  ...
  <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4">
    ...
    <p className="text-white text-lg md:text-2xl text-center max-w-3xl leading-relaxed drop-shadow-md">
      Dive deeper into the Word of God through our carefully curated sermons and weekly Bible studies. 
      Join us in growing spiritually and living purpose-driven lives.
    </p>
  </div>
</section>
