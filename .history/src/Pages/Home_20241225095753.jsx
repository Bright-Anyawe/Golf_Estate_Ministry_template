...
const Home = () => {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="latestSermon container flex flex-col  justify-center items-center gap-10  bg-no-repeat bg-cover bg-center bg-opacity-50 p-8 py-16 text-center md:text-left">
