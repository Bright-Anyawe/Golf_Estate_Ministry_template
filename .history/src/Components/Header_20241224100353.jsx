    ...
    <header className="bg-gray-800 text-white p-4 top-0  fixed flex justify-center items-center w-screen h-20 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="flex items-center text-xl">
          <NavLink to="/" className=" activeLink mx-2 hover:text-blue-400">
            Home
          </NavLink>
          <NavLink
            to="/announcement"
            className="activeLink mx-2 hover:text-blue-400"
          >
            Announcement
          </NavLink>
          <NavLink
          ...
          <NavLink to="/event" className=" activeLink mx-2 hover:text-blue-400">
            Events
          </NavLink>
{/* 
          <div
          ...
          >
            <NavLink className=" activeLink focus:outline-none hover:text-blue-400">
              Ministries
            </NavLink>
            {isDropdownOpen && (
