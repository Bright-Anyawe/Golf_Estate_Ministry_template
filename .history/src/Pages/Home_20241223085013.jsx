...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="upcomingEvent container flex flex-col justify-center items-center  py-16 text-center md:text-left">
        <h2 className="text-2xl font-bold mb-4 text-#377dff">
          Upcoming Events
        </h2>
        {upcomingEvent ? (
          <div className="eventCard bg-white shadow-lg rounded-lg  flex flex-col items-center text-center">
