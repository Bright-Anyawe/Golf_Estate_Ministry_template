        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {LeaderShip.map((leader, index) => (
            <div
              key={index}
              className="bg-white shadow-md p-6 rounded-lg text-center"
              onClick={() => handleOpenModal(leader.image)} // Handle card click to open modal
            >
              <img
                src={leader.image}
                alt={leader.name}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {memberShip.map((member, index) => (
            <div
              ...
              className="bg-white shadow-md p-6 rounded-lg text-center"
            >
              <div className="w-80 h-50 mx-auto mb-4 flex items-center justify-center rounded-full overflow-hidden">
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-60 h-60 mx-auto rounded-full mb-4 object-cover"
