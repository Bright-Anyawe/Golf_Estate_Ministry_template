    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="relative w-full h-screen overflow-hidden bg-gray-900">
        ...
        <video
          ...
          src="/assets/26th-december-2024-convention.mp4" // Ensure correct path
          autoPlay
          loop
          muted
        ></video>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4 sm:px-6 lg:px-8">
          ...
          {/* Navigation Button */}
          <button
            className="bg-indigo-600 hover:bg-indigo-800 py-3 px-8 rounded-lg text-lg sm:text-xl font-medium shadow-lg transform transition-transform hover:scale-105 duration-300"
