      ...
      <div className="weeklyAnnouncement p-6 flex flex-col gap-10 bg-gradient-to-br from-blue-100 to-blue-300">
        ...
        <div className="flex flex-wrap gap-5 items-center justify-center">
          {weeklyAnnouncements.map((announcement) => (
            <div
              key={announcement.id}
              className="bg-white shadow-lg rounded-xl p-6 flex flex-col items-center w-72 h-80 transform hover:scale-105 transition-transform duration-300 ease-in-out hover:shadow-2xl"
            >
