...
const Home = () => {
  ...
  return (
    <div>
      <section className="bg-blue-500 text-white text-center overflow-hidden">
        <div className="w-full h-full max-w-full max-h-full relative overflow-hidden  mt-24 px-10 py-10">
          <img
            src="/Cop%20welcome%20image.png"
            alt="Cop welcome image"
            className="w-full h-full rounded-l-lg rounded-b-3xl object-cover"
          />
        </div>
      </section>
