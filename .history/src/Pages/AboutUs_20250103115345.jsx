...
const [readMore, setReadMore] = useState("false");
  ...
  return (
      ...
      <section className="mb-12">
        ...
        {!readMore && (
          <Typography variant="body1" color="textPrimary" paragraph>
            McKeown&apos;s leadership saw the church grow globally, transitioning
            to indigenous leadership in 1982 under Rev. Fred S. Sarfo. Today, it
            operates in over 170 countries with 4.2 million members, emphasizing
        ...
        {readMore && (
          <Typography variant="body1" color="textPrimary" paragraph>
            ...
            Pentecost has its roots in the Apostolic Faith Mission, a Pentecostal
            movement that emerged in the United States in the early 20th century.
            In the 1920s, missionaries from the Apostolic Faith Mission arrived
            in the Gold Coast (now Ghana), preaching the gospel and establishing
            churches.
            <br />
            <strong>Founding and Growth (1930s-1950s):</strong> In 1937, James
            McKeown, a British missionary, and Peter Anim, a Ghanaian evangelist,
            founded the Gold Coast Apostolic Church. The church grew rapidly, and
            by the 1950s, it had become one of the largest Pentecostal
            denominations in Ghana.
          </Typography>
        )}
