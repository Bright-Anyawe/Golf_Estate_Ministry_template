...
const upcomingEvent = events[0]
  ...
  return (
    <div>
      ...
      <section className="latestSermon container flex flex-col justify-center items-center gap-10 bg-[url('/public/sundayService.png')] bg-no-repeat p-8 py-16 text-center md:text-left">
        <h2 className="text-2xl font-bold mb-4 text-#377dff">
