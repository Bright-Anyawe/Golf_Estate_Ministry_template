...
const Home = () => {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-between py-8 overflow-hidden">
        {/* Top Text */}
        ...
        <div className="relative w-full h-2/4">
          <video
            ...
            src="/assets/26th-december-2024-convention.mp4" // Ensure the correct file path
            autoPlay
            loop
            muted
          />
        ...
        <div className="text-center z-10">
          <button
            className="bg-indigo-700 text-white py-3 px-6 rounded-lg text-xl mt-4 hover:bg-indigo-800 shadow-lg transition duration-300"
