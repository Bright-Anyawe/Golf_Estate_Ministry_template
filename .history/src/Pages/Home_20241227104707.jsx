      ...
      <section className="upcomingEvent container flex flex-col justify-center items-center gap-10 bg-gradient-to-r from-teal-400 via-blue-500 to-indigo-600 p-8 py-16 text-center md:text-left">
        ...
        {events.length > 1 ? (
          events.slice(0, 2).map((event, index) => (
            <div
              key={index}
              className="eventCard bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-2xl rounded-lg p-8 flex flex-col items-center text-center md:flex-row gap-6 mb-6"
            >
