  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-between py-8 overflow-hidden bg-white">
        <div className="subSectionContainer flex flex-col lg:flex-row items-center justify-between p-6 gap-20">
          {/* Text Content */}
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative w-full h-0 pb-[56.25%] lg:pb-0 lg:h-[553.39px] max-w-[988.22px] mx-auto rounded-lg overflow-hidden">
              <video
                width="320"
                height="540"
