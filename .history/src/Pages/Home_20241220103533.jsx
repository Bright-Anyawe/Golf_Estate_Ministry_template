const Home = () => (
  <div>
    ...
    <section className=" bg-slate-400 flex justify-center align-middle p-8 h-full">
      <div className="h-72">
        <img src="public/Golf Estate Assembly(Cop).jpg" alt="Presiding20%Image" className="  h-1/3" />
      </div>
      <div className="h-72">
