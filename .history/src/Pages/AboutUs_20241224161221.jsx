...
const memberShip = [
  {
    image: "/path/to/member1.jpg", // Add appropriate image source
    name: "Member One",
    title: "Member Title", // Add the title or role for the member
    description: "Description about the member goes here.", // Add a description for the member
  },
  {
