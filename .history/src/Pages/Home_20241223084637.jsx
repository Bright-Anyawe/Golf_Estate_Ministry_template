...
const upcomingEvent = events[0]
  ...
  return (
    <div>
      ...
      <section className="latestSermon container flex flex-col justify-center items-center gap-10 p-8 py-16 text-center md:text-left">
        <h2 className="text-2xl font-bold mb-4 text-#377dff">Current Bible Studies & Sermon</h2>
      ...
      <section className="upcomingBibleStudy container flex flex-col justify-center items-center p-8 py-16 text-center md:text-left"></section>
