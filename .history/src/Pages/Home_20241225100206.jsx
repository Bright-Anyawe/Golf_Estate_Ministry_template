...
const Home = () => {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="latestSermon container flex flex-col justify-center items-center gap-10 bg-[url('/path-to-background-image.jpg')] bg-cover bg-center bg-opacity-60 p-8 py-16 text-center md:text-left">
        ...
        <div className="teachingContainer flex flex-col md:flex-row justify-center items-center gap-10">
          ...
          <div className="flex flex-col justify-center items-center gap-5 bg-white bg-opacity-80 p-6 rounded-lg shadow-lg">
        ...
        {/* Learn More Button */}
        <button
          className="WordBtn bg-indigo-700 text-white p-3 rounded-lg text-xl mt-8 hover:bg-indigo-800 transition duration-300"
