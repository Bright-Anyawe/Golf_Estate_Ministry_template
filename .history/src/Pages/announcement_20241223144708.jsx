export const Announcement = () => {
  ...
  return (
    <div>
      ...
      <div className="weeklyAnnouncement p-6">
        <h2 className="text-3xl font-semibold mb-4 text-center">Weekly Announcements</h2>
      ...
      <div className="monthlyAnnouncement p-6">
        <h2 className="text-3xl font-semibold mb-4 text-center">Monthly Announcements</h2>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
