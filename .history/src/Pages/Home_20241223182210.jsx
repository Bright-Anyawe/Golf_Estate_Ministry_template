...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="latestSermon container flex flex-col text-4xl  justify-center items-center gap-10 bg-[url('/public/sundayService.png')] bg-no-repeat bg-cover bg-center bg-opacity-50 p-8 py-16 text-center md:text-left">
