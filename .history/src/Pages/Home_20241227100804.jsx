    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="relative w-full h-screen overflow-hidden bg-gray-900">
        ...
        <video
          ...
          src="/26th-december-2024-convention.mp4" // Updated file path format
          autoPlay
          loop
          muted
        />
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-white text-center px-4 sm:px-6 lg:px-8">
          ...
          <button
            className="bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-8 rounded-lg text-lg sm:text-xl font-medium shadow-lg transition-transform transform hover:scale-105 duration-300"
