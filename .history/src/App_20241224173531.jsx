...
function App() {
  ...
  const weeklyAnnouncements = useState(
    [
      {
        id: 1,
  ...
  const monthlyAnnouncements = useState(
    [
      {
        id: 1,
  ...
  return (
    <>
      <GeneralContext.Provider value={{ events, sermons, bibleStudies, weeklyAnnouncements, monthlyAnnouncements }}>
        <Header />
        <main>
          <Outlet />
        </main>
