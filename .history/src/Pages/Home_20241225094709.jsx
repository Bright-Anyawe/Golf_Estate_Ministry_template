...
const Home = () => {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="upcomingEvent container bg-[url('/sabbathSunday.png')] flex flex-col justify-center items-center gap-10 bg-gray-300  p-8 py-16 text-center md:text-left">
