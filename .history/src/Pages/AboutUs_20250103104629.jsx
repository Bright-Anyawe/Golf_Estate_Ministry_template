      ...
      <section className="mb-12">
        ...
        {readMore && (
          <Typography variant="body1" color="textPrimary" paragraph>
            ...
            denomination that originated in Ghana. Here's a brief history: Early
            Beginnings (1920s-1930s) The Church of Pentecost has its roots in
            the Apostolic Faith Mission, a Pentecostal movement that emerged in
            the United States in the early 20th century. In the 1920s,
            missionaries from the Apostolic Faith Mission arrived in the Gold
            Coast (now Ghana), preaching the gospel and establishing churches.
            Founding and Growth (1930s-1950s) In 1937, James McKeown, a British
            missionary, and Peter Anim, a Ghanaian evangelist, founded the Gold
            Coast Apostolic Church. The church grew rapidly, and by the 1950s,
            it had become one of the largest Pentecostal denominations in Ghana.
          </Typography>
        )}
      </section>
