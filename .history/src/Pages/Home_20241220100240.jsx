...
const Home = () => (
  <div>
    <section className="bg-blue-500 text-white text-center p-8 bg-[url('/Cop%20welcome%20image.png')] bg-cover bg-center h-screen ">
      <img src="/Cop%20welcome%20image.png" alt="Cop welcome image" />
