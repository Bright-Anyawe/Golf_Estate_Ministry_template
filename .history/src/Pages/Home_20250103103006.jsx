  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-between py-8 overflow-hidden bg-white">
        ...
        <div className="relative w-full h-full max-w-[988.22px] max-h-[553.39px] h-auto rounded-lg overflow-hidden p-4 sm:p-6 lg:p-0 lg:w-[988.22px] lg:h-[553.39px]">
          <video
            width="320"
            height="540"
            className=" responsive-video w-full h-auto object-contain rounded-xl lg:w-[988.22px] lg:h-[553.39px]"
            src="/31st all night 2025.mp4"
            autoPlay
            loop
            muted
