...
export const Announcement = () => {
  ...
  return (
    <div>
      ...
      <div className="introductionSection w-96 h-96 rounded-full bg-[url('/announcement.png')] bg-cover mt-20 bg-center h-screen flex justify-center items-center text-white">
